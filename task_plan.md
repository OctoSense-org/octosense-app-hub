...
9. Implement and verify installed-version launch (plan 02) — Hub, shared shell and refreshed Home consumer verified locally; native device acceptance remains.
...
13. Implement Card application lifecycle and state (plan 06) — in progress.
14. Continue remaining plans in dependency order — pending.
